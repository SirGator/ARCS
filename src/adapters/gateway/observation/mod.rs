    ...
    pub fn submit_boundary(
        ...
        let (
            ...
            (
                ...
                registered
                    .grant()
                    .observation_subject_scopes
                    .iter()
                    .filter(|scope| scope.capability_id == submission.capability_id)
                    .cloned()
                    .collect::<Vec<_>>(),
        ...
        let capability = CapabilityRef {
            ...
            capability_id: submission.capability_id.clone(),
        };
        if !subject_scopes
            .iter()
            .any(|scope| scope.allows(&submission.subject))
        {
            return Err(AdapterGatewayError::SubjectOutsideGrant {
                capability,
